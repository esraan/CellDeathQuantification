...
class SPICalculator:
    def __init__(self, XY, die_times, treatment, temporal_resolution, n_scramble=1000,
                 draw=False, **kwargs):

        create_df_csv = kwargs.get('create_df_csv', False)
    ...
    def create_dataframe(self):
        ...
        feature_table = pd.DataFrame(
            {'id': instances,
             ...
             'die_time_real': [x * self.temporal_resolution for x in self.die_times],
